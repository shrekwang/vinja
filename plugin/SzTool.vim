...
function! Jdext()
  ...
  autocmd BufEnter  SzToolView_Jdb  nmap <buffer><silent><c-o>    :python jdb.toggleQuickStep()<cr>
  ...
  autocmd BufEnter  SzToolView_Jdb  imap <buffer><silent><c-o>    <c-o>:python jdb.toggleQuickStep()<cr>
